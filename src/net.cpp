...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Oscintcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"oscintcointools.com", "oscintcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"oscintcointools.com", "testnet-seed.oscintcointools.com"},
    {"xurious.com", "testnet-seed.osc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Oscintcoin is probably already running."), addrBind.ToString().c_str());
        else
